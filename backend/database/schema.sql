...
CREATE TABLE IF NOT EXISTS bookings (
    ...
    contact_info TEXT,
    -- The date the user says they want to travel, if they gave one - a real
    -- travel agent always asks; this is optional since older bookings and
    -- the demo catalog itself have no date to check it against.
    travel_date DATE,
